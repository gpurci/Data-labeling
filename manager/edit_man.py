...
class EditManager(object):
    ...
    def object_edit(self):
        if (self.targetMan.is_rectangle_mod()):
            ...
            elif ((self.x0 >= (x0 - step_point)) and (self.x0 <= (x0 + step_point)) and (self.y0 >= (y0 - step_point)) and (self.y0 <= (y0 + step_point))):
                self.edit_point = self.POINT_00
                shape_rectangle = (x0 + d_x, y0 + d_y, x1, y1)
            elif ((self.x0 >= (x1 - step_point)) and (self.x0 <= (x1 + step_point)) and (self.y0 >= (y0 - step_point)) and (self.y0 <= (y0 + step_point))):
                self.edit_point = self.POINT_01
                shape_rectangle = (x0, y0 + d_y, x1 + d_x, y1)
            elif ((self.x0 >= (x0 - step_point)) and (self.x0 <= (x0 + step_point)) and (self.y0 >= (y1 - step_point)) and (self.y0 <= (y1 + step_point))):
                self.edit_point = self.POINT_10
                shape_rectangle = (x0 + d_x, y0, x1, y1 + d_y)
            elif ((self.x0 >= (x1 - step_point)) and (self.x0 <= (x1 + step_point)) and (self.y0 >= (y1 - step_point)) and (self.y0 <= (y1 + step_point))):
